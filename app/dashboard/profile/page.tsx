...
import { Loader2, User, Mail, Shield, ShieldCheck } from "lucide-react";
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1 space-y-6">
              <div className="bg-white rounded-3xl p-6 border border-surface-200 text-center">
                <div className="w-24 h-24 bg-gradient-to-tr from-brand-100 to-brand-50 text-brand-600 rounded-full flex items-center justify-center mx-auto mb-4 text-3xl font-bold border-4 border-white shadow-sm">
                  {user?.email?.charAt(0).toUpperCase()}
                </div>
                <h2 className="font-bold text-surface-900 text-lg mb-1 truncate px-2" title={user?.email}>
                  {user?.email}
                </h2>
